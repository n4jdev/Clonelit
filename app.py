...
if uploaded_file and text_input:
    with st.spinner("Processing voice sample..."):
        ...
        # Get the S3 URL for the cloned voice
        ...
        if s3_url:
            ...
            with st.spinner("Generating speech..."):
                audio_content = generate_tts(text_input, s3_url)
...
st.markdown("---")
st.write("Note: This app uses external APIs for voice cloning and text-to-speech generation.")
